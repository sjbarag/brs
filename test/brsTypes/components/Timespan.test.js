    ...
    describe("methods", () => {
        ...
        describe("getsecondstoiso8601date", () => {
            it("returns seconds from now until a valid ISO8601 date", async () => {
                ...
                let result1 = await getsecondstoiso8601date.call(interpreter, new BrsString(dateToParse1));
                let result2 = await getsecondstoiso8601date.call(interpreter, new BrsString(dateToParse2));
            ...
            it("accepts other ISO8601 formats and returns correct seconds", async () => {
                ...
                let result = await getsecondstoiso8601date.call(interpreter, new BrsString(dateToParse));
                expect(getsecondstoiso8601date).toBeTruthy();
